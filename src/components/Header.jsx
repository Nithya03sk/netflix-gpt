...
const handleSignOut = () => {
  ...
  return (
    <div className='absolute w-screen px-8 py-2 z-9 bg-gradient-to-b from-black flex justify-between'>
      <img className='w-44' alt = "netflix-logo" src = "https://cdn.cookielaw.org/logos/dd6b162f-1a32-456a-9cfe-897231c7763c/4345ea78-053c-46d2-b11e-09adaef973dc/Netflix_Logo_PMS.png"></img>
